...
namespace OpenEducator.Code.ContentTypes {
    ...
    public class CodePenContent: Content {
        ...
        public CodePenContent(string user, string slugHash, string title, string height = "300px", bool waitBeforeLoading = false, string themeId = "dark") {
            User = user;
            Slug = slugHash;
            Title = title;
            ThemeId = themeId;
        ...
        public override string Render() {
            ...
            */
            ...
            return Wrap("p", "See The Pen <a href=\"http://codepen.io/team/codepen/pen/PNaGbb/\">Example Editable Embed</a>" , Style, (Classes ?? new string[]{ }).Concat(new[] { "codepen" }).ToArray(), ID, Open + " " + OpenMaker(new List<KeyValuePair<string, string>>() {
